...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $data = array(
            ...
            'category_section'	 => clean($_POST['category_section']),
            'category_type'  => clean($_POST['category_type']),
    	...
    	$sql_categories = "SELECT * FROM tbl_category_section";
	$result_cate_section = $connect->query($sql_categories);
                            ...
                            <div class="row clearfix">
                                ...
                                <div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select class="form-control" name="category_section" id="category_section">
                                            <option value="">Select Category Section</option>
                                           <?php 	
												while ($r_c_row = mysqli_fetch_array($result_cate_section)) {
													$sel = '';
													if ($r_c_row['name'] == $row['category_section']) {
													$sel = "selected";	
												}	
											?>
										    <option value="<?php echo $r_c_row['name'];?>" <?php echo $sel; ?>><?php echo $r_c_row['name'];?></option>
										        <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group form-float col-sm-12">
										<div class="form-line">
											<div class="font-12">Category Type</div>
											<select class="form-control" name="category_type" required id="category_type">
												<option value="">Select Category Type</option>
												<option 
                                                <?php 
                                                if ($row['category_type'] == 'Free') {
                                                    echo 'selected';
                                                }else{
                                                    echo '';
                                                }
