...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($data['type'] == 'url') {
            ...
            $bigImage = $actualLink.'/upload/'.$data['image'];
        }
...
?>
	...
	<section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Send Phraser Notification</a></li>
        </ol>
	                        ...
	                        <div class="body">
	                        	...
	                        	<div class="row clearfix">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="message" id="message" placeholder="Message" value="<?php echo $data['quote']; ?>" required/>
                                        </div>
                                    </div>
			                       	...
			                       	<div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                        	<?php if ($data['type'] == 'url') { ?>
                                        		<input type="file" class="dropify-image" data-max-file-size="8M" data-allowed-file-extensions="jpg jpeg png gif" data-default-file="<?php echo $data['image_url'];?>" data-show-remove="false" disabled/>
                                        	<?php } else { ?>
                                            	<input type="file" class="dropify-image" data-max-file-size="8M" data-allowed-file-extensions="jpg jpeg png gif" data-default-file="upload/<?php echo $data['image']; ?>" data-show-remove="false" disabled/>
                                        	<?php } ?>
                                        </div>
                                    </div>
